...
def post():
   ...
   article = {'url':url_receive,'comment':comment_receive, 'category':category_receive, 'no':article_no} # 받은 걸 딕셔너리로 만들고,
